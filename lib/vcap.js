    ...
    var Collection = function (collection, schema) {
        ...
        this.get = function (id, callback) {
            ...
            authedRequest(getPath(collection, id), 'GET', true,
                ...
                callback(null,
                    (plural && (result.resources !== undefined)) ?
...
//         };
    ...
    this.apps.summary = function (name, callback) {
        authedRequest(getPath('apps', name, 'summary'), 'GET', callback);
    };

    this.apps.stats = function (name, callback) {
        authedRequest(getPath('apps', name, 'stats'), 'GET', callback);
    };
